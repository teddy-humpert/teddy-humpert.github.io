...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const numbers = document.querySelectorAll('button.number') //type.class
  // loop over each of the numbers
  // add a click event listener to each number to call the function clickNumber - doesnt req () cause ref.
